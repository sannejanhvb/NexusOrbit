 ...
 * This file demonstrates how to integrate Nexusorbit with a web frontend
 */

// For React/Vue/Angular applications
export class NexusorbitClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NexusorbitClient(provider, contractAddress);
